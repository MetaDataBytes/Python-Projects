...
def build_list_of_team_members(count: int) -> list:
    """
...
def print_member_registration(start: float, end: float, team: list) -> None:
    """
...
def make_request(member: dict) -> json:
    """
...
async def pre_async_request(team: list) -> list:
    """
...
async def async_request(session: aiohttp.ClientSession, member: dict) -> json:
    """
